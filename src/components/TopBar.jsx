export default function TopBar() {
    return (
        <div className="top-bar row w-100 px-md-5 d-none d-md-flex m-auto">
            <div className="col-12 col-md-6 my-auto text-center text-md-start">
                <ul id="icones" className="social-icons my-auto mx-md-5">
                    <li className="border-light border-start px-2"><a href="">
                    ...
                    <li><a href="" className="border-light border-start px-2">
                    ...
                    <li className="border-light border-start border-end px-2"><a href="">
